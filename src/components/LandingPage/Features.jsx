    ...
    <section className="features">
      <main className="features__main" ref={featureRef}>
        ...
        <article className="feature feature--2">
          <h3 className="heading__tertiary">Task Prioritization</h3>
          <p className="feature__para">
            Allow users to prioritize their tasks by assigning different levels
            of importance or urgency to each task.
          </p>
          <img
            src={taskImg}
            alt="Stars with hand"
        ...
        <article className="feature feature--4">
          <h3 className="heading__tertiary">Percentage Completion</h3>
          <p className="feature__para">
            Users can specify the percentage of a task that is complete, helping
            them quantify their progress accurately.
          </p>
          <img
            src={percImg}
            alt="Stars with hand"
        ...
        <article className="feature feature--5">
          <img
            src={barChartImg}
            alt="Stars with hand"
            className="feature__img feature__img--3"
          />
          <h3 className="heading__tertiary heading__tertiary--light">
            Productivity Analytics
          </h3>
          <p className="feature__para feature__para--light">
            Track and display statistics on your task completion rate, allowing
        ...
        <article className="feature feature--6">
          <img
            src={arrowImg}
            alt="Stars with hand"
            className="feature__img feature__img--4"
          />
          <h3 className="heading__tertiary heading__tertiary--light">
            Hit your goals
          </h3>
        ...
        <article className="feature feature--7">
          <img
            src={lazyImg}
            alt="Stars with hand"
            className="feature__img feature__img--5"
          />
